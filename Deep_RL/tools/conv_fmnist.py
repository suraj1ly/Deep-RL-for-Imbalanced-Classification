...
#---
def get_data(train):
	data_raw = datasets.FashionMNIST('../data/dl/', train=train, download=True,  transform=transforms.Compose([
...
data_train.to_pickle("../data/fmnist-train")
data_val.to_pickle("../data/fmnist-val")
data_test.to_pickle("../data/fmnist-test")
...
meta.to_pickle("../data/fmnist-meta")
